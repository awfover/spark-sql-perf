...
class TPCDSTables(
  ...
  val tables = Seq(
    Table("catalog_sales",
      partitionColumns = "cs_item_sk" :: "cs_order_number" :: Nil,
      'cs_sold_date_sk          .int,
      'cs_sold_time_sk          .int,
      'cs_ship_date_sk          .int,
    ...
    Table("catalog_returns",
      partitionColumns = "cr_item_sk" :: "cr_order_number" :: Nil,
    ...
    Table("inventory",
      partitionColumns = "inv_date_sk" :: "inv_item_sk" :: Nil,
      'inv_date_sk          .int,
      'inv_item_sk          .int,
      'inv_warehouse_sk     .int,
      'inv_quantity_on_hand .int),
    Table("store_sales",
      partitionColumns = "ss_item_sk" :: "ss_ticket_number" :: Nil,
      'ss_sold_date_sk      .int,
      'ss_sold_time_sk      .int,
      'ss_item_sk           .int,
      'ss_customer_sk       .int,
    ...
    Table("store_returns",
      partitionColumns = "sr_item_sk" :: "sr_ticket_number" ::Nil,
    ...
    Table("web_sales",
      partitionColumns = "ws_item_sk" :: "ws_order_number" :: Nil,
      'ws_sold_date_sk          .int,
      'ws_sold_time_sk          .int,
      'ws_ship_date_sk          .int,
      'ws_item_sk               .int,
    ...
    Table("web_returns",
      partitionColumns = "wr_order_number" :: "wr_item_sk" ::Nil,
    ...
    Table("call_center",
      partitionColumns = "cc_call_center_sk" :: Nil,
    ...
    Table("catalog_page",
      partitionColumns = "cp_catalog_page_sk" :: Nil,
      ...
      'cp_type                  .string),
    Table("customer",
      partitionColumns = "c_customer_sk" :: Nil,
      'c_customer_sk             .int,
    ...
    Table("customer_address",
      partitionColumns = "ca_address_sk" :: Nil,
      'ca_address_sk             .int,
    ...
    Table("customer_demographics",
      partitionColumns = "cd_demo_sk" :: Nil,
      'cd_demo_sk                .int,
      'cd_gender                 .string,
    ...
    Table("date_dim",
      partitionColumns = "d_date_sk" :: Nil,
      'd_date_sk                 .int,
      'd_date_id                 .string,
      'd_date                    .date,
      'd_month_seq               .int,
    ...
    Table("household_demographics",
      partitionColumns = "hd_demo_sk" :: Nil,
      'hd_demo_sk                .int,
    ...
    Table("income_band",
      partitionColumns = "ib_income_band_sk" :: Nil,
      'ib_income_band_sk         .int,
      'ib_lower_bound            .int,
      'ib_upper_bound            .int),
    Table("item",
      partitionColumns = "i_item_sk" :: Nil,
      'i_item_sk                 .int,
      'i_item_id                 .string,
    ...
    Table("promotion",
      partitionColumns = "p_promo_sk" :: Nil,
      'p_promo_sk                .int,
      'p_promo_id                .string,
      'p_start_date_sk           .int,
      'p_end_date_sk             .int,
    ...
    Table("reason",
      partitionColumns = "r_reason_sk" :: Nil,
      'r_reason_sk               .int,
      'r_reason_id               .string,
      'r_reason_desc             .string),
    Table("ship_mode",
      partitionColumns = "sm_ship_mode_sk" :: Nil,
      'sm_ship_mode_sk           .int,
      ...
      'sm_contract               .string),
    Table("store",
      partitionColumns = "s_store_sk" :: Nil,
      's_store_sk                .int,
      's_store_id                .string,
    ...
    Table("time_dim",
      partitionColumns = "t_time_sk" :: Nil,
      't_time_sk                 .int,
      't_time_id                 .string,
      't_time                    .int,
      't_hour                    .int,
      ...
      't_meal_time               .string),
    Table("warehouse",
      partitionColumns = "w_warehouse_sk" :: Nil,
      'w_warehouse_sk           .int,
    ...
    Table("web_page",
      partitionColumns = "wp_web_page_sk" :: Nil,
      'wp_web_page_sk           .int,
      ...
      'wp_max_ad_count          .int),
    Table("web_site",
      partitionColumns = "web_site_sk" :: Nil,
      'web_site_sk              .int,
      'web_site_id              .string,
